...
\\DATA 602 - Project
\\Professor: Dr. Thuntida Ngamkham
...
```{r}
mel_final<-select(melbourne,Rooms,Type,Price,Date,Distance,
...
```{r}
sapply(mel_final,function(x)  sum(is.na(x)))
```
